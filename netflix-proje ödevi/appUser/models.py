...
class Category(models.Model):
    ...
    movies = models.ManyToManyField('Movie', verbose_name=("Movies"), related_name='categories', blank=True) 
...
class Movie(models.Model):
    ...
    image = models.FileField(("Resim"), upload_to='image', max_length=100, null=True)
